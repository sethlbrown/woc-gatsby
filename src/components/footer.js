...
export default function Footer() {
                ...
                <div className="flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-4">
                    <div className="mt-12 sm:mt-8 w-full sm:col-span-1">
                        ...
                        <ul className="font-thin mt-2 tracking-wider">
                            ...
                            <li className="mt-2"><a href="tel:970-340-8151">970.340.8151</a></li>
                        </ul>
                        <div className="flex items-center justify-start mt-4">            
                            <a href="#" className="hover:text-white">
                                <span className="sr-only">Facebook</span>
                                <div><img src={facebookLogo} alt="Facebook Icon" className="h-6 w-6" /></div>
                            </a>
        <a href="#" className="hover:text-white">
    ...
    <div className="mt-8 w-full sm:col-span-1">
      <h4 className="flex flex-grow-0 text-gray-100 leading-5 font-semibold tracking-wider">Hours</h4>
    ...
    <path d="M16.2 0H1.8C0.81 0 0.00899999 0.817788 0.00899999 1.81731L0 12.7212C0 13.7207 0.81 14.5385 1.8 14.5385H16.2C17.19 14.5385 18 13.7207 18 12.7212V1.81731C18 0.817788 17.19 0 16.2 0ZM16.2 3.63462L9 8.17788L1.8 3.63462V1.81731L9 6.36058L16.2 1.81731V3.63462Z" fill="white"/>
    </svg>
          <label htmlFor="email" className="block pl-2 font-bold leading-5 text-gray-100">Sign-Up for Updates!</label>
        </div>
    <div className="mt-2 flex max-w-l z-10">
      <div className="relative flex-grow focus-within:z-10">
        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        </div>
        <input id="email" className="form-input block w-full rounded-none pl-4 h-11 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Your Email Address" />
      </div>
      <button className="relative inline-flex items-center">
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M0 0H45V45H0V0Z" fill="#25A2AA"/>
  <path d="M22.4767 15L30.0001 22.5L22.4767 30" fill="#25A2AA"/>
  <path d="M22.4767 15L30.0001 22.5L22.4767 30" stroke="white" strokeWidth="3" strokeMiterLimit="10"/>
  <path d="M15 22.499H30" stroke="white" strokeWidth="3" strokeMiterLimit="10"/>
  </svg>
      </button>
    </div>
    <div className="mt-12 text-sm sm:flex sm:items-center">
        <img src={wocLogo} alt="Logo for the Way of Compassion Foundation" />
      <div className="font-thin leading-snug mt-4 sm:ml-4 text-gray-100 text-sm tracking-wider">
    The WOC Bike Project is part of the Way of Compassion Foundation.<br /> &copy; { new Date().getFullYear() } Way of Compassion Foundation
      </div>
    </div>
  </div>
